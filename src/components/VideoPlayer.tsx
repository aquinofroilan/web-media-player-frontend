  ...
  return (
    <div className="absolute inset-0 flex items-center justify-center bg-card">
      <div className="text-center">
        ...
        <h3 className="text-lg font-medium text-muted-foreground mb-2">No video selected</h3>
        <p className="text-sm text-muted-foreground/70">Select a file from the list to start playback</p>
      </div>
    </div>
  );
}
...
export default function VideoPlayer({ 
  ...
  }, [duration, filename, toggleFullscreen, togglePlayPause]);
