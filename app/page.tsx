...
import { Monitor, Music, FileVideo, Keyboard } from "lucide-react"
    ...
    return (
        <div className='min-h-screen bg-background p-4 md:p-6 lg:p-8'>
            <div className='grid grid-cols-1 gap-4 md:gap-6'>
                                ...
                                <div className='flex flex-wrap gap-3 text-sm text-muted-foreground'>
                                    ...
                                    {metadata.audio && metadata.audio.length > 0 && (
                                        <div className='flex items-center gap-1.5'>
                                            ...
                                            <span>
                                                {metadata.audio.length} audio track
                                                {metadata.audio.length > 1 ? "s" : ""}
                                            </span>
                                        </div>
                                    )}
                                    {metadata.has51Audio && (
                ...
                <div className='lg:col-span-4 xl:col-span-3 order-1 lg:order-2 h-75 lg:h-[calc(100vh-200px)]'>
                    <FileList
                        files={files}
            ...
            <Card className='mt-8'>
                <CardContent className='py-4'>
                    <div className='flex items-center gap-2 text-muted-foreground text-xs flex-wrap justify-center'>
                        ...
                        <kbd className='px-1.5 py-0.5 bg-muted rounded text-xs'>Space/K</kbd>{" "}
                        Play/Pause
